...
import (
	...
	"log"
	"net/http"
	"url-short/serializer/json"
	"url-short/serializer/messagepack"
	"url-short/shortener"
...
// NewHandler takes in redirect Service and returns a handler with get post methods
...
func setupResponse(w http.ResponseWriter, contentType string, body []byte, statusCode int) {
	w.Header().Set("Content-Type", contentType) //json or messagepack
