...
func (r *mongoRepository) Find(code string) (*shortener.Redirect, error) {
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			return nil, errors.Wrap(shortener.ErrRedirectNotFound, "[ERROR] repository.Redirect.Find")
		}
		return nil, errors.Wrap(err, "[ERROR] repository.Redirect.Find")
	}
	return redirect,nil
}
...
func (r *mongoRepository) Store(redirect *shortener.Redirect) error {
	...
	if err != nil {
		return errors.Wrap(err, "[ERROR] repository.Redirect.Store")
	}
	return nil
}
